...
("Fantastic Four by Dan Slott Omnibus Vol 1 2", dict(id="slott-o2", title="Fantastic Four by Dan Slott Omnibus", vol="Vol. 2",
  creators="Dan Slott, R.B. Silva & Ze Carlos", era="2020–2022", released="Dec 2026",
  art="o-slott", tex="tex-cosmic", chapterby="series", spine="By Dan Slott",
 cover="Art/Fantastic-Four/slott-o2.jpg",
  note="Ships 1 December 2026 \u2014 on the shelf ahead of that because its contents, links and jacket are all real. Slott finishes his run on the Reckoning War, the cosmic story he had been setting up since he started: the Watchers, the first war Reed ever lost, and the answer to why Uatu was watching in the first place."),),
